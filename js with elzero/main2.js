...
/*#59 Function return: == break in this example
...
//#60 Function default parameters:(in-case of missing para)

function sayHi(userName, age = "Unknown") {
  /*  if (age === undefined){
        age = "Unknown"; //undefined default Method
    }
...
//#60 Rest Parameters:(in-case unknown numbers of paras)
...
//#73 Filter + Map
let mix = "A13bS2ZX";
//show numbers only and multiply em by itself.
let b = 1;
let mult = mix
  .split("")
...
let bigest = theBigest.reduce((acc, cur) =>
